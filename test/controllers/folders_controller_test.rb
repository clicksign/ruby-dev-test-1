...
class FoldersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create folder" do
    assert_difference("Folder.count") do
      post folders_url, params: { folder: { lft: @folder.lft, name: @folder.name, parent_id: @folder.parent_id, rgt: @folder.rgt } }
    end
  ...
  test "should update folder" do
    patch folder_url(@folder), params: { folder: { lft: @folder.lft, name: @folder.name, parent_id: @folder.parent_id, rgt: @folder.rgt } }
