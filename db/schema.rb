...
ActiveRecord::Schema[7.0].define(version: 2022_09_26_024256) do
  ...
  create_table "directory_files", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  add_foreign_key "directory_files", "directories"
end
